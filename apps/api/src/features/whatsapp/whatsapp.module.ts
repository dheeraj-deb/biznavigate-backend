...
import { MessageDebounceProcessor, AGENT_QUEUE_EVENTS } from './processors/message-debounce.processor';
...
@Module({
  ...
  providers: [
    ...
    // QueueEvents lets waitUntilFinished() subscribe to agent job completion events
    {
      provide: AGENT_QUEUE_EVENTS,
      useFactory: (config: ConfigService) =>
        new QueueEvents(AGENT_QUEUE_NAME, {
          connection: {
