...
@ApiTags('Hotel Pricing — Recommendations')
@ApiBearerAuth()
...
export class PricingController {
  ...
  @Post('recommend')
  @ApiOperation({
    summary: 'Get AI pricing recommendation for a hotel room',
    description: 'Fetches Xotelo competitor rates, scores demand, calls LLM for narrative, persists result.',
  })
  ...
  @Get('history')
  @ApiOperation({ summary: 'Get pricing recommendation history for a hotel' })
  ...
  @Post('outcome')
  @ApiOperation({
    summary: 'Record actual booking outcome against a recommendation (feeds ML training data)',
  })
  @ApiBody({ type: RecordOutcomeDto })
