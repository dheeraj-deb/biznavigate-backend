...
export class Workflow {
    ...
    onNodeStart?: (node: BaseNode, context: WorkflowNodeExecutionContext) => Promise<string | void>;
    onNodeComplete?: (stepId: string | void, node: BaseNode, result: any, context: WorkflowNodeExecutionContext) => Promise<void>;
    onNodeError?: (stepId: string | void, node: BaseNode, error: Error, context: WorkflowNodeExecutionContext) => Promise<void>;
    ...
    private async executeNode(node: BaseNode | null): Promise<any> {
        ...
        let stepId: string | void;
        try {
            stepId = await this.onNodeStart?.(node, this.nodeContext);
            ...
            await this.onNodeComplete?.(stepId, node, result, this.nodeContext);
            ...
            await this.onNodeError?.(stepId, node, error, this.nodeContext);
