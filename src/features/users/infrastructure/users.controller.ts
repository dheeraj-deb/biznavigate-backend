...
import { UserResponseDto, ZohoAuthResponseDto, ZohoCredentialsSaveResponseDto } from '../application/dto/user-response.dto';
...
export class UsersController {
  ...
  @ApiResponse({ status: 201, description: 'User created with Zoho integration', type: ZohoAuthResponseDto })
  ...
  @Post('zoho/credentials')
  @ApiOperation({ summary: 'Save Zoho OAuth credentials' })
  @ApiResponse({ status: 200, description: 'Credentials saved successfully', type: ZohoCredentialsSaveResponseDto })
  @ApiResponse({ status: 400, description: 'Bad request' })
  @ApiQuery({ name: 'code', description: 'Authorization code from Zoho' })
  @ApiQuery({ name: 'state', description: 'State parameter containing credentials' })
