...
import { WhatsAppCatalogOrderService } from './whatsapp-catalog-order.service';
...
export class WhatsAppService {
  ...
  async handleMessageWebhook(message: any, metadata: any, contacts: any[]): Promise<void> {
    ...
    try {
      ...
      console.log("message.type1==>", message.type)
      ...
      switch (message.type) {
        ...
        case 'order':
          ...
          return; // Early return - order handling is complete
        case 'reaction':
