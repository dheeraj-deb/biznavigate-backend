...
export class CustomersController {
  ...
  async registerShop(
    ...
    console.log("Registering shop with data:", createCustomerDto);
    console.log("Client ID:", clientId);
    console.log("Platform:", platform);
    const result = await this.customersService.registerShop(
      createCustomerDto,
      clientId,
      platform
    );
  ...
  async createSalesOrder(
    ...
    const result = await this.customersService.createSalesOrder(
      orderData,
      clientId,
      platform
    );
  ...
  async getCustomersByBusinessUser(
    ...
    const customers =
      await this.customersService.getCustomersByBusinessUser(businessUserId);
    return {
      statusCode: HttpStatus.OK,
