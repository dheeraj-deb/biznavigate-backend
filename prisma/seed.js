...
async function main() {
    ...
    const customers = [
        {
            ...
            total_orders: 25,
            total_spent: 125000,
            last_order_date: new Date(Date.now() - 2 * 24 * 60 * 60 * 1000),
            engagement_score: 95,
        },
        {
            business_id: business.business_id,
            ...
            total_orders: 18,
            total_spent: 75000,
            last_order_date: new Date(Date.now() - 5 * 24 * 60 * 60 * 1000),
            engagement_score: 88,
        },
        {
            business_id: business.business_id,
            ...
            total_orders: 8,
            total_spent: 35000,
            last_order_date: new Date(Date.now() - 15 * 24 * 60 * 60 * 1000),
            engagement_score: 72,
        },
        {
            business_id: business.business_id,
            ...
            total_orders: 6,
            total_spent: 28000,
            last_order_date: new Date(Date.now() - 20 * 24 * 60 * 60 * 1000),
            engagement_score: 65,
        },
        {
            business_id: business.business_id,
            ...
            total_orders: 2,
            total_spent: 8500,
            last_order_date: new Date(Date.now() - 3 * 24 * 60 * 60 * 1000),
            engagement_score: 55,
        },
        {
            business_id: business.business_id,
            ...
            total_orders: 1,
            total_spent: 4500,
            last_order_date: new Date(Date.now() - 7 * 24 * 60 * 60 * 1000),
            engagement_score: 45,
        },
        {
            business_id: business.business_id,
            ...
            total_orders: 5,
            total_spent: 22000,
            last_order_date: new Date(Date.now() - 120 * 24 * 60 * 60 * 1000),
            engagement_score: 25,
        },
        {
            business_id: business.business_id,
            ...
            total_orders: 4,
            total_spent: 18000,
            last_order_date: new Date(Date.now() - 150 * 24 * 60 * 60 * 1000),
            engagement_score: 20,
        },
        {
            business_id: business.business_id,
            ...
            total_orders: 3,
            total_spent: 12000,
            last_order_date: new Date(Date.now() - 30 * 24 * 60 * 60 * 1000),
            engagement_score: 50,
        },
        {
            business_id: business.business_id,
        ...
        },
        {
            ...
            total_orders: 32,
            total_spent: 185000,
            last_order_date: new Date(Date.now() - 1 * 24 * 60 * 60 * 1000),
            engagement_score: 98,
        },
        {
            business_id: business.business_id,
            ...
            total_orders: 28,
            total_spent: 142000,
            last_order_date: new Date(Date.now() - 4 * 24 * 60 * 60 * 1000),
            engagement_score: 92,
        },
        {
            business_id: business.business_id,
            ...
            total_orders: 22,
            total_spent: 98000,
            last_order_date: new Date(Date.now() - 6 * 24 * 60 * 60 * 1000),
            engagement_score: 90,
        },
        {
            business_id: business.business_id,
            ...
            total_orders: 9,
            total_spent: 42000,
            last_order_date: new Date(Date.now() - 12 * 24 * 60 * 60 * 1000),
            engagement_score: 75,
        },
        {
            business_id: business.business_id,
            ...
            total_orders: 7,
            total_spent: 31500,
            last_order_date: new Date(Date.now() - 18 * 24 * 60 * 60 * 1000),
            engagement_score: 68,
        },
        {
            business_id: business.business_id,
            ...
            total_orders: 5,
            total_spent: 24000,
            last_order_date: new Date(Date.now() - 25 * 24 * 60 * 60 * 1000),
            engagement_score: 60,
        },
        {
            business_id: business.business_id,
            ...
            total_orders: 6,
            total_spent: 27500,
            last_order_date: new Date(Date.now() - 22 * 24 * 60 * 60 * 1000),
            engagement_score: 63,
        },
        {
            business_id: business.business_id,
        ...
        },
        {
            ...
            total_orders: 1,
            total_spent: 5200,
            last_order_date: new Date(Date.now() - 8 * 24 * 60 * 60 * 1000),
            engagement_score: 48,
        },
        {
            business_id: business.business_id,
        ...
        },
        {
            ...
            total_orders: 1,
            total_spent: 4800,
            last_order_date: new Date(Date.now() - 11 * 24 * 60 * 60 * 1000),
            engagement_score: 42,
        },
        {
            business_id: business.business_id,
            ...
            total_orders: 8,
            total_spent: 36000,
            last_order_date: new Date(Date.now() - 95 * 24 * 60 * 60 * 1000),
            engagement_score: 32,
        },
        {
            business_id: business.business_id,
            ...
            total_orders: 6,
            total_spent: 28500,
            last_order_date: new Date(Date.now() - 110 * 24 * 60 * 60 * 1000),
            engagement_score: 28,
        },
        {
            business_id: business.business_id,
            ...
            total_orders: 4,
            total_spent: 19000,
            last_order_date: new Date(Date.now() - 135 * 24 * 60 * 60 * 1000),
            engagement_score: 22,
        },
        {
            business_id: business.business_id,
            ...
            total_orders: 4,
            total_spent: 16200,
            last_order_date: new Date(Date.now() - 35 * 24 * 60 * 60 * 1000),
            engagement_score: 55,
        },
        {
            business_id: business.business_id,
            ...
            total_orders: 5,
            total_spent: 21000,
            last_order_date: new Date(Date.now() - 28 * 24 * 60 * 60 * 1000),
            engagement_score: 62,
        },
        {
            business_id: business.business_id,
            ...
            total_orders: 2,
            total_spent: 7800,
            last_order_date: new Date(Date.now() - 14 * 24 * 60 * 60 * 1000),
            engagement_score: 45,
        },
        {
            business_id: business.business_id,
            ...
            total_orders: 1,
            total_spent: 3200,
            last_order_date: new Date(Date.now() - 9 * 24 * 60 * 60 * 1000),
            engagement_score: 38,
        },
        {
            business_id: business.business_id,
    ...
    for (const variantData of laptopVariants) {
        await prisma.product_variants.create({
            data: Object.assign(Object.assign({ product_id: createdProducts[0].product_id }, variantData), { in_stock: true }),
        });
    ...
    const order1 = await prisma.orders.create({
        data: {
            business_id: business.business_id,
            tenant_id: tenant.tenant_id,
            customer_id: createdCustomers[0].customer_id,
            order_type: 'product',
            ...
            shipped_at: new Date(Date.now() - 8 * 24 * 60 * 60 * 1000),
    ...
    const order2 = await prisma.orders.create({
        data: {
            business_id: business.business_id,
            tenant_id: tenant.tenant_id,
            customer_id: createdCustomers[1].customer_id,
            order_type: 'product',
    ...
    const order3 = await prisma.orders.create({
        data: {
            business_id: business.business_id,
            tenant_id: tenant.tenant_id,
            customer_id: createdCustomers[2].customer_id,
            order_type: 'product',
    ...
    const order4 = await prisma.orders.create({
        data: {
            business_id: business.business_id,
            tenant_id: tenant.tenant_id,
            customer_id: createdCustomers[3].customer_id,
            order_type: 'product',
    ...
    const order5 = await prisma.orders.create({
        data: {
            business_id: business.business_id,
            tenant_id: tenant.tenant_id,
            customer_id: createdCustomers[4].customer_id,
            order_type: 'product',
    ...
    const order6 = await prisma.orders.create({
        data: {
            business_id: business.business_id,
            tenant_id: tenant.tenant_id,
            customer_id: createdCustomers[10].customer_id,
            order_type: 'product',
    ...
    const order7 = await prisma.orders.create({
        data: {
            business_id: business.business_id,
            tenant_id: tenant.tenant_id,
            customer_id: createdCustomers[13].customer_id,
            order_type: 'product',
    ...
    const order8 = await prisma.orders.create({
        data: {
            business_id: business.business_id,
            tenant_id: tenant.tenant_id,
            customer_id: createdCustomers[11].customer_id,
            order_type: 'product',
    ...
    const order9 = await prisma.orders.create({
        data: {
            business_id: business.business_id,
            tenant_id: tenant.tenant_id,
            customer_id: createdCustomers[14].customer_id,
            order_type: 'product',
    ...
    const order10 = await prisma.orders.create({
        data: {
            business_id: business.business_id,
            tenant_id: tenant.tenant_id,
            customer_id: createdCustomers[15].customer_id,
            order_type: 'product',
    ...
    const order11 = await prisma.orders.create({
        data: {
            business_id: business.business_id,
            tenant_id: tenant.tenant_id,
            customer_id: createdCustomers[16].customer_id,
            order_type: 'product',
    ...
    const order12 = await prisma.orders.create({
        data: {
            business_id: business.business_id,
            tenant_id: tenant.tenant_id,
            customer_id: createdCustomers[17].customer_id,
            order_type: 'product',
    ...
    const order13 = await prisma.orders.create({
        data: {
            business_id: business.business_id,
            tenant_id: tenant.tenant_id,
            customer_id: createdCustomers[12].customer_id,
            order_type: 'product',
    ...
    const order14 = await prisma.orders.create({
        data: {
            business_id: business.business_id,
            tenant_id: tenant.tenant_id,
            customer_id: createdCustomers[18].customer_id,
            order_type: 'product',
    ...
    const order15 = await prisma.orders.create({
        data: {
            business_id: business.business_id,
            tenant_id: tenant.tenant_id,
            customer_id: createdCustomers[19].customer_id,
            order_type: 'product',
    ...
    const order16 = await prisma.orders.create({
        data: {
            business_id: business.business_id,
            tenant_id: tenant.tenant_id,
            customer_id: createdCustomers[20].customer_id,
            order_type: 'product',
    ...
    const order17 = await prisma.orders.create({
        data: {
            business_id: business.business_id,
            tenant_id: tenant.tenant_id,
            customer_id: createdCustomers[21].customer_id,
            order_type: 'product',
    ...
    const order18 = await prisma.orders.create({
        data: {
            business_id: business.business_id,
            tenant_id: tenant.tenant_id,
            customer_id: createdCustomers[22].customer_id,
            order_type: 'product',
    ...
    const order19 = await prisma.orders.create({
        data: {
            business_id: business.business_id,
            tenant_id: tenant.tenant_id,
            customer_id: createdCustomers[23].customer_id,
            order_type: 'product',
    ...
    const order20 = await prisma.orders.create({
        data: {
            business_id: business.business_id,
            tenant_id: tenant.tenant_id,
            customer_id: createdCustomers[24].customer_id,
            order_type: 'product',
