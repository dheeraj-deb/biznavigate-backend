...
async function updateRetailOrderWorkflow() {
  try {
    // Find the Retail Order Processing workflow by ID
    ...
    if (!workflow) {
      console.error('❌ Retail Order Processing workflow not found');
      return;
    }

    console.log('✅ Found workflow:', workflow.workflow_name);

    // Updated workflow definition with invoice generation
    const updatedDefinition = {
      ...
      states: {
        ...
        create_order: {
          ...
          transitions: [{ to: 'fetch_product_details' }],
        },
        ...
        fetch_product_details: {
          ...
          transitions: [{ to: 'generate_invoice' }],
        },
          ...
          actions: [
            {
              ...
              params: {
                script: `
                  ...
                  console.log('Invoice calculated:', { subtotal, taxAmount, total });
        ...
        send_invoice: {
          ...
          transitions: [{ to: 'update_order_totals' }],
        },
    ...
    console.log('✅ Retail Order Processing workflow updated successfully');
    console.log('\nWorkflow flow:');
    console.log('1. Check cart confirmation');
    console.log('2. Create order');
    console.log('3. Fetch product details');
    console.log('4. Generate invoice');
    console.log('5. Send invoice to user');
    console.log('6. Update order totals');
  } catch (error) {
